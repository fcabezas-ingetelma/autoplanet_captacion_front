...
class GestionEnrolamientoQuilicura extends React.Component {
    constructor(props) {
        super(props);
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(GestionEnrolamientoQuilicura));