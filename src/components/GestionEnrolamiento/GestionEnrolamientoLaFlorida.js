...
class GestionEnrolamientoLaFlorida extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <Row>
                        <Col>
                            <Table striped bordered hover responsive>
                                <thead>
                                    <tr>
                                        <th colSpan='4' className='text-center text-white' style={{backgroundColor:'#E36924'}}>Nº de Visitas a la página <p><strong>IP ÚNICA</strong> (Nuevo)</p></th>
                                    </tr>
                                    <tr>
                                        <th>Día</th>
                                        <th>QR Vendedor</th>
                        ...
                        <Col>
                            <Table striped bordered hover responsive>
                                <thead>
                                    <tr>
                                        <th colSpan='4' className='text-center text-white' style={{backgroundColor:'#B60B14'}}>Nº de Enrolamientos <p> </p><p> </p></th>
                                    </tr>
                                    <tr>
                                        <th>Día</th>
                                        <th>QR Vendedor</th>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(GestionEnrolamientoLaFlorida));